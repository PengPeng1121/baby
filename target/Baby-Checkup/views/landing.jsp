...
<nav class="navbar navbar-default navbar-fixed-top front-nav">
    <div class="container">
        <div>
            ...
            <div class="nav-brand"><a href="home"><img class="img-responsive" src="http://123.56.19.0/image/<s:property value="hospital.logoLanding"/>" alt="Babycheckup" onerror="this.src='statics/img/CIPlogo.png'" style="height: 30px;width: 250px;"/></a></div>
        </div>
        <!-- 导航栏右侧区域 -->
        <%--<div class="nav-right">
            ...
            <div class="col-md-9">
                <div class="panel panel-default front-panel" style="background: #e7e7e7; border: 0;">
                    <div class="panel-body" style="height: 100%;padding: 0px;">
                        <img src="http://123.56.19.0/image/<s:property value="hospital.bannerLanding"/>" class="change-img" onerror="this.src='statics/img/banner.png'" style="width: 100%;max-width: 100%; display: block;">
