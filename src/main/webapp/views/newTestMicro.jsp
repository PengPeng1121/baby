...
<div class="front-inner front-inner-media">
    <div class="container">
        <h1 style="margin-top: 0px;margin-bottom: 20px;">微量元素</h1>
        <form class="form-horizontal">
            ...
            <div class="panel panel-default front-panel">
                ...
                <div class="panel-heading">上传微量元素图片</div>
                <div class="panel-body front-no-padding" style="padding: 15px;">
...
<script type="text/javascript">
    ...
    function uploadImg() {
        ...
        formData.append("testId", 45);
        formData.append("babyId", $('#babyid').val());
        $.ajax({
            url: "babyImg/uploadMicroImg",
            type: "POST",
    ...
    function score() {
        ...
        var data = {};
        data ['resultMicro.microImgUrl'] = $("#imgUrl").val();
        data ['resultMicro.babyId'] = parseInt($("#babyid").val());
