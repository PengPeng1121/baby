...
<script type="text/javascript">
    ...
    function score() {
        ...
        var data = "{";
        data += "'resultTooth20.babyId':" + $("#babyid").val() + ",";
        data += "'resultTooth20.attentionBrushWay':" + a1 + ",";
        data += "'resultTooth20.attentionBrushHabit':" + a2 + ",";
        data += "'resultTooth20.attentionTeethSituation':" + a3 + ",";
        data += "'resultTooth20.attentionFu':" + a4 + ",";      
        
        data += "'resultTooth20.leftUp1':" + leftUp1 + ",";   
        data += "'resultTooth20.leftUp2':" + leftUp2 + ",";   
        data += "'resultTooth20.leftUp3':" + leftUp3 + ",";
        data += "'resultTooth20.leftUp4':" + leftUp4 + ",";
        data += "'resultTooth20.leftUp5':" + leftUp5 + ",";
        // data += "'resultTooth20.leftUp6':" + leftUp6 + ",";
        // data += "'resultTooth20.leftUp7':" + leftUp7 + ",";
        data += "'resultTooth20.rightUp1':" + rightUp1 + ",";
        data += "'resultTooth20.rightUp2':" + rightUp2 + ",";
        data += "'resultTooth20.rightUp3':" + rightUp3 + ",";
        data += "'resultTooth20.rightUp4':" + rightUp4 + ",";
        data += "'resultTooth20.rightUp5':" + rightUp5 + ",";
        // data += "'resultTooth20.rightUp6':" + rightUp6 + ",";
        // data += "'resultTooth20.rightUp7':" + rightUp7 + ",";

        data += "'resultTooth20.leftDown1':" + leftDown1 + ",";
        data += "'resultTooth20.leftDown2':" + leftDown2 + ",";
        data += "'resultTooth20.leftDown3':" + leftDown3 + ",";
        data += "'resultTooth20.leftDown4':" + leftDown4 + ",";
        data += "'resultTooth20.leftDown5':" + leftDown5 + ",";
        // data += "'resultTooth20.leftDown6':" + leftDown6 + ",";
        // data += "'resultTooth20.leftDown7':" + leftDown7 + ",";
        data += "'resultTooth20.rightDown1':" + rightDown1 + ",";
        data += "'resultTooth20.rightDown2':" + rightDown2 + ",";
        data += "'resultTooth20.rightDown3':" + rightDown3 + ",";
        data += "'resultTooth20.rightDown4':" + rightDown4 + ",";
        data += "'resultTooth20.rightDown5':" + rightDown5 + ",";
        // data += "'resultTooth20.rightDown6':" + rightDown6 + ",";
        // data += "'resultTooth20.rightDown7':" + rightDown7 + ",";
        data += "}";
        data = eval('(' + data + ')');
        if (remark) {
            data['resultTooth20.remark'] = remark;
        }
        $.ajax({
            url: 'saveresultTooth20',
            type: 'post',
            data: data,
            success:function (json) {
                var rId = json.resultTooth20.id;
                var refreshData = {
                    babyid: $("#babyid").val(),
                    testId: 54,
                    resultId: rId
                ...
                $.ajax({
                    ...
                    success:function (json) {
                        console.log('更新时间成功');
                        window.location = "showresultTooth20?id=" + rId;
                    }
                })
            }
        })
