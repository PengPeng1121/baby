...
<div class="front-inner front-inner-media">
    <div class="container">
        <h1 style="margin-top: 0px;margin-bottom: 20px;">骨碱酶</h1>
        <form class="form-horizontal">
            ...
            <div class="panel panel-default front-panel">
                ...
                <div class="panel-heading">上传骨碱酶图片</div>
                <div class="panel-body front-no-padding" style="padding: 15px;">
...
<script type="text/javascript">
    ...
    function uploadImg() {
        ...
        formData.append("testId", 46);
        formData.append("babyId", $('#babyid').val());
        $.ajax({
            url: "babyImg/uploadBoneImg",
            type: "POST",
    ...
    function score() {
        ...
        var data = {};
        data ['resultBone.boneImgUrl'] = $("#imgUrl").val();
        data ['resultBone.babyId'] = parseInt($("#babyid").val());
        ...
        $.ajax({
            ...
            success:function (json) {
                ...
                $.ajax({
                    ...
                    success:function (json) {
                        console.log('更新时间成功');
                        window.location = "showresultBone?id=" + rId;
                    }
                })
                // window.location = "showresultBone?id=" + json.resultBone.id;
            }
        })
    }
