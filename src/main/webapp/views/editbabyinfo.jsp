    ...
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success : function(data) {
                ...
                $("#baby_name").val(data.name.trim());
                $("#doctor").val(data.userid);
                $("#birthday").val(data.birthday);
                $("#nation").val(data.nation);
                $("#relation").val(data.relation);
                $("#blood").val(data.bloodtype);
                $("#postcode").val(data.postcode);
                $("#account").val(data.account);
                $("#province").val(data.province);
                $("#city").val(data.city);
                $("#address").val(data.address);
                $("#father_name").val(data.father.name.trim());
                $("#father_career").val(data.father.career.trim());
                $("#f_tel").val(data.father.worktime.trim());
                $("#education-f").val(data.father.worktime);
                $("#f_worktime").val(data.father.worktime);
                $("#f_birthday").val(data.father_birth);
                $("#f_email").val(data.father.email);
                $("#mother_name").val(data.mother.name.trim());
                $("#mother_career").val(data.mother.carrer.trim());
                $("#education-m").val(data.mother.education);
                $("#f_tel").val().trim(data.mother.tel);
                $("#m_worktime").val(data.mother.worktime);
                $("#m_birthday").val(data.mother_birth);
                $("#m_email").val(data.email);
                $("#mother_illness").val(data.motherIllness);
                $("#pregnant").val(data.parity);
                $("#duration").val(data.pregnancy);
                $("#birth-way").val(data.delivery);
                $("#education").val(data.education);
                $("#pre_delivery").val(data.preDelivery);
                $("#deformity").val(data.deformity);
                $("#only_child").val(data.onlyChild);
                $("#frontal_suture1").val(data.frontalSuture1);
                $("#frontal_suture2").val(data.frontalSuture2);
                $("#mother_birthage").val(data.motherBirthage);
                $("#marriage").val(data.marriage);
                $("#choke").val(data.asphyxia);
                $("#birth_weight").val(data.birthWeight);
                $("#jaundice").val(data.jaundice);
                $("#pumping").val(data.havePumping);
                $("#pumping-times").val(data.pumpingTimes);
                $("#pumping-begin").val(data.pumpingBegin);
                $("#family_history").val(data.familyHistory);
                $("#illness_history").val(data.illnessHistory);
