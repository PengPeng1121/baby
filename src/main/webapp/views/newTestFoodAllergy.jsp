...
<div class="front-inner front-inner-media">
    <div class="container">
        <h1 style="margin-top: 0px;margin-bottom: 20px;">14项慢性食物过敏原</h1>
        <form class="form-horizontal">
            ...
            <div class="panel panel-default front-panel">
                ...
                <div class="panel-heading">上传14项慢性食物过敏原图片</div>
                <div class="panel-body front-no-padding" style="padding: 15px;">
...
<script type="text/javascript">
    ...
    function uploadImg() {
        ...
        formData.append("testId", 50);
        formData.append("babyId", $('#babyid').val());
        $.ajax({
            url: "babyImg/uploadFoodAllergyImg",
            type: "POST",
            ...
            success: function (json) {
                $('#imgUrl').val(json.foodAllergyImgUrl);
    ...
    function score() {
        ...
        var data = {};
        data ['resultFoodAllergy.foodAllergyImgUrl'] = $("#imgUrl").val();
        data ['resultFoodAllergy.babyId'] = parseInt($("#babyid").val());

        $.ajax({
            url: 'saveresultFoodAllergy',
            type: 'post',
            data: data,
            success:function (json) {
                window.location = "showresultFoodAllergy?id=" + json.resultFoodAllergy.id;
            }
        })
    }
