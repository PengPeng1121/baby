...
<div class="front-inner front-inner-media" style="background-color: transparent;">
        ...
        <input id="babyid" type="hidden" value="<s:property value="resultFastAllergy.babyid"/>">
        <input id="ImgUrl" type="hidden" value="<s:property value="resultFastAllergy.fastAllergyImgUrl"/>">
        ...
        <div class="container" id="hemaFront">
            <div class="panel panel-default front-panel"  style="border: 0px; background-color: transparent;">
                <div class="panel-body front-no-padding" style="height:1060px;border:0;background-color: transparent">
                    ...
                    <img style="width: 822px;position: absolute;z-index: -1;height: 1122px;" src="statics/img/hemaBgFastAllergyBoy.jpg">
                    </s:if>
                    <s:if test="baby.gender == 0">
                    <img style="width: 822px;position: absolute;z-index: -1;height: 1122px;" src="statics/img/hemaBgFastAllergyGirl.jpg">
                    </s:if>



                    <img id="eyeImg" src="<s:property value="resultFastAllergy.fastAllergyImgUrl"/>">
