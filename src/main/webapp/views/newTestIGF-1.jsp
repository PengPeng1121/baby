...
<div class="front-inner front-inner-media">
    <div class="container">
        <h1 style="margin-top: 0px;margin-bottom: 20px;">胰岛素样生长因子IGF-1</h1>
        <form class="form-horizontal">
            ...
            <div class="panel panel-default front-panel">
                ...
                <div class="panel-heading">胰岛素样生长因子IGF-1图片</div>
                <div class="panel-body front-no-padding" style="padding: 15px;">
...
<script type="text/javascript">
    ...
    function uploadImg1() {
        ...
        formData.append("testId", 58);
        formData.append("babyId", $('#babyid').val());
        $.ajax({
            url: "babyImg/uploadIgf1Img",
            type: "POST",
    ...
    function score() {
        ...
        var data = {};
        data ['resultIgf1.igf1ImgUrl'] = $("#imgUrl1").val();
        
        data ['resultIgf1.babyId'] = parseInt($("#babyid").val());
        ...
        $.ajax({
            ...
            success:function (json) {
                ...
                $.ajax({
                    ...
                    success:function (json) {
                        console.log('更新时间成功');
                        window.location = "showresultIgf1?id=" + rId;
                    }
                })
