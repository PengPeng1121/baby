            ...
            <div class="panel-body front-no-padding info" style="padding: 5px;border:0 ">
                <table style="width: 100%;border:0 ">
                    ...
                    <tr>
                        ...
                        <td class="col-md-2"><s:property value="resultGroup2020.height"/></td>
                        <td class="col-md-1">体重(KG):</td>
                        <td class="col-md-2"><s:property value="resultGroup2020.weight"/></td>
                        <td class="col-md-1 head-table">头围(CM):</td>
                        <td class="col-md-2 head-table"><s:property value="resultGroup2020.head"/></td>
