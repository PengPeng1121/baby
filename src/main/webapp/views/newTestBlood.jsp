...
<div class="front-inner front-inner-media">
    <div class="container">
        <h1 style="margin-top: 0px;margin-bottom: 20px;">血常规</h1>
        <form class="form-horizontal">
            ...
            <div class="panel panel-default front-panel">
                ...
                <div class="panel-heading">上传血常规筛查图片</div>
                <div class="panel-body front-no-padding" style="padding: 15px;">
...
<script type="text/javascript">
    ...
    function score() {
        ...
        var data = {};
        data ['resultBlood.bloodImgUrl'] = $("#imgUrl").val();
        data ['resultBlood.babyId'] = parseInt($("#babyid").val());
