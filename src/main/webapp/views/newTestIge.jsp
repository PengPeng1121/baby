...
<div class="front-inner front-inner-media">
    <div class="container">
        <h1 style="margin-top: 0px;margin-bottom: 20px;">免疫球蛋白E(总ige)</h1>
        <form class="form-horizontal">
            ...
            <div class="panel panel-default front-panel">
                ...
                <div class="panel-heading">上传免疫球蛋白E(总ige)图片</div>
                <div class="panel-body front-no-padding" style="padding: 15px;">
...
<script type="text/javascript">
    ...
    function uploadImg1() {
        ...
        formData.append("testId", 59);
        formData.append("babyId", $('#babyid').val());
        $.ajax({
            url: "babyImg/uploadIgeImg",
            type: "POST",
    ...
    function score() {
        ...
        var data = {};
        data ['resultIge.igeImgUrl'] = $("#imgUrl1").val();
        
        data ['resultIge.babyId'] = parseInt($("#babyid").val());
        ...
        $.ajax({
            ...
            success:function (json) {
                ...
                $.ajax({
                    ...
                    success:function (json) {
                        console.log('更新时间成功');
                        window.location = "showresultIge?id=" + rId;
                    }
                })
