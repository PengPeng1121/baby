...
<div class="front-inner front-inner-media">
    <div class="container">
        <h1 style="margin-top: 0px;margin-bottom: 20px;">育儿技能评估（0-3岁)</h1>
...
<script type="text/javascript">
    ...
    function failReasons(ordinal, reasons) {
        ...
        $.frontModal({
            href: "modals/modal_question_reasons0_3.jsp?reasons=" + reasons + "&qid="+ordinal,
            title: "请选择答案："
    ...
    function preview() {
        if(prepare()) {
            $.frontModal({size: 'modal-md', title: '预览', href: 'modals/model_preview_result0_3.jsp'});
        }
    }
        ...
        if(prepare()) {
            $.tipModal('confirm', 'success', '确定保存本测评？', function(result) {
                if(result) {
                    ...
                    for(var i = 0; i < questionSum; i++) {
                        data += "'result0_3.desc" + (i + 1) + "':'" + questionReasonDesc[i] + "',"
                    }




                    data += "'result0_3.a1':" + questionScore[1] + ",";
                    data += "'result0_3.a2':" + questionScore[2] + ",";
                    data += "'result0_3.a3':" + questionScore[3] + ",";
                    data += "'result0_3.a4':" + questionScore[4] + ",";
                    data += "'result0_3.a5':" + questionScore[5] + ",";
                    data += "'result0_3.a6':" + questionScore[6] + ",";
                    data += "'result0_3.a7':" + questionScore[7] + ",";
                    data += "'result0_3.a8':" + questionScore[8] + ",";
                    

                    data += "'result0_3.babyId':" + $("#babyid").val() + ",";
                    var answerRelation = $("#answerRelation").val();
                    answerRelation= " ' "+ answerRelation +" ' ";
                    data += "'result0_3.answerRelation':" + answerRelation + "}";
                    ...
                    $.ajax({
                        ...
                        success:function (json) {
                            window.location = "showresult0_3?id=" + json.result0_3.id;
                        }
                    })
                }
            });
