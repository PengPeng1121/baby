...
<div class="front-inner front-inner-media">
    <div class="container">
        <h1 style="margin-top: 0px;margin-bottom: 20px;">21项速发过敏原</h1>
        <form class="form-horizontal">
            ...
            <div class="panel panel-default front-panel">
                ...
                <div class="panel-heading">上传21项速发过敏原图片</div>
                <div class="panel-body front-no-padding" style="padding: 15px;">
...
<script type="text/javascript">
    ...
    function uploadImg() {
        ...
        formData.append("testId", 49);
        formData.append("babyId", $('#babyid').val());
        $.ajax({
            url: "babyImg/uploadFastAllergyImg",
            type: "POST",
            ...
            success: function (json) {
                $('#imgUrl').val(json.fastAllergyImgUrl);
    ...
    function score() {
        ...
        var data = {};
        data ['resultFastAllergy.fastAllergyImgUrl'] = $("#imgUrl").val();
        ...
        $.ajax({
            ...
            data: data,
            success:function (json) {
                window.location = "showresultFastAllergy?id=" + json.resultFastAllergy.id;
            }
        })
    }
