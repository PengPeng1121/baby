...
<div class="front-inner front-inner-media">
    <div class="container">
        <h1 style="margin-top: 0px;margin-bottom: 20px;">血型鉴定</h1>
        <form class="form-horizontal">
            ...
            <div class="panel panel-default front-panel">
                ...
                <div class="panel-heading">上传血型鉴定图片</div>
                <div class="panel-body front-no-padding" style="padding: 15px;">
...
<script type="text/javascript">
    ...
    function uploadImg() {
        ...
        $.ajax({
            ...
            success: function (json) {
                $('#imgUrl').val(json.bloodTypeImgUrl);
    ...
    function score() {
        ...
        var data = {};
        data ['resultBloodType.bloodTypeImgUrl'] = $("#imgUrl").val();
        data ['resultBloodType.babyId'] = parseInt($("#babyid").val());

        $.ajax({
            url: 'saveresultBloodType',
            type: 'post',
            data: data,
            success:function (json) {
                window.location = "showresultBloodType?id=" + json.resultBloodType.id;
            }
        })
    }
