...
<div class="front-inner front-inner-media">
    <div class="container">
        <h1 style="margin-top: 0px;margin-bottom: 20px;">骨密度</h1>
        <form class="form-horizontal">
            ...
            <div class="panel panel-default front-panel">
                ...
                <div class="panel-heading">上传骨密度图片</div>
                <div class="panel-body front-no-padding" style="padding: 15px;">
...
<script type="text/javascript">
    ...
    function score() {
        ...
        var data = {};
        data ['resultBMD.bmdImgUrl'] = $("#imgUrl").val();
        data ['resultBMD.babyId'] = parseInt($("#babyid").val());
        ...
        $.ajax({
            ...
            success:function (json) {
                ...
                $.ajax({
                    ...
                    success:function (json) {
                        console.log('更新时间成功');
                        window.location = "showresultBMD?id=" + rId;
                    }
                })
                // window.location = "showresultBMD?id=" + json.resultBMD.id;
            }
        })
    }
