...
<div class="modal-content" id="savebabymodal">
    ...
    <div class="modal-body">
        ...
        <a type="button" class="btn  modal-box text-center" href="javascript:start_QiZhi2020()" style="margin-top: 10px"><h4
        ...
        <a type="button" class="btn  modal-box text-center" href="javascript:start_Group2020()" style="margin-top: 10px"><h4
        style="color: white;font-size: small">生长发育测验2020</h4></a>

        <a type="button" class="btn  modal-box text-center" href="javascript:start_Physical()" style="margin-top: 10px"><h4
        style="color: white;font-size: small">体格头面检查</h4></a>
        <a type="button" class="btn  modal-box text-center" href="javascript:start_Summary()" style="margin-top: 10px"><h4
        ...
        <a type="button" class="btn  modal-box text-center" href="javascript:start_Plan()" style="margin-top: 10px"><h4
        ...
        <a type="button" class="btn  modal-box text-center" href="javascript:start_Eye()" style="margin-top: 10px"><h4
        style="color: white;font-size: small">视力</h4></a>

        <a type="button" class="btn  modal-box text-center" href="javascript:start_Ear()" style="margin-top: 10px"><h4
        style="color: white;font-size: small">听力</h4></a>

        <a type="button" class="btn  modal-box text-center" href="javascript:start_BMD()" style="margin-top: 10px"><h4
        style="color: white;font-size: small">骨密度</h4></a>

        <a type="button" class="btn  modal-box text-center" href="javascript:start_Blood()" style="margin-top: 10px"><h4
        style="color: white;font-size: small">血常规</h4></a>

        <a type="button" class="btn  modal-box text-center" href="javascript:start_Micro()" style="margin-top: 10px"><h4
        style="color: white;font-size: small">微量元素</h4></a>

        <a type="button" class="btn  modal-box text-center" href="javascript:start_Bone()" style="margin-top: 10px"><h4
        style="color: white;font-size: small">骨碱酶</h4></a>

        <a type="button" class="btn  modal-box text-center" href="javascript:start_Urine()" style="margin-top: 10px"><h4
