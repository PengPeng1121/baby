...
public class ResultAction50 {
    ...
    public String showResult50() {
        ...
        resultRecord = TestResultRecordManager.find(17,id);
        return SUCCESS;
    }

    //保存记录，没有新增，有修改
    public String saveRecord50(){
        TestResultRecord record = TestResultRecordManager.find(17,resultRecord.getResultId());
        if(record==null){
            //保存
            resultRecord.setTestId(17);
