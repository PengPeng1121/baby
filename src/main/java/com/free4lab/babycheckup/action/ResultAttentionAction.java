...
import com.free4lab.babycheckup.manager.ResultAttentionManager;
...
public class ResultAttentionAction {
    ...
    public String showResult() {
        resultAttention = ResultAttentionManager.findResultByid(id);
        // 拼装url 用虚拟路径
        baby = BabyManager.findById(resultAttention.getBabyId());
        Date d1 = baby.getBirthday();
        stime = new  SimpleDateFormat("yyyy-MM-dd").format(resultAttention.getTime());
