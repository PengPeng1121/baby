...
import com.free4lab.babycheckup.manager.ResultTooth20Manager;
 ...
 */
public class ResultTooth20Action {
    ...
    public String showResultTooth20() {
        resultTooth20 = ResultTooth20Manager.findResultByid(id);
        baby = BabyManager.findById(resultTooth20.getBabyId());
        Date d1 = baby.getBirthday();
        stime = new  SimpleDateFormat("yyyy-MM-dd").format(resultTooth20.getTime());
