 ...
 */
@Entity
@Table(name = "result_fast_allergy", schema = "babycheckup", catalog = "")
public class ResultFastAllergy {
    private int id;
    private int testId;
    private int hosId;
    private int babyId;
     ...
     * 文件地址
     */
    private String fastAllergyImgUrl;
    /**
     * 备注
     */
    ...
    @Basic
    @Column(name = "fast_allergy_img_url")
