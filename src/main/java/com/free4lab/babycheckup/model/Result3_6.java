...
@Entity
@Table(name = "result3_6", schema = "babycheckup")
public class Result3_6 {
    private int id;
    private int testId;
    private int babyId;
    ...
    public boolean equals(Object o) {
        ...
        if (Double.compare(result.a7, a7) != 0) return false;

        if (Double.compare(result.a8, a8) != 0) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        temp = Double.doubleToLongBits(a7);
        result = 31 * result + (int) (temp ^ (temp >>> 32));
