...
@Entity
@Table(name = "result_rear", schema = "babycheckup", catalog = "")
public class ResultRear {
    private int id;
    private int testId;
    private int hosId;
    private int babyId;
    ...
    @Basic
    @Column(name = "rear_date")
    public Date getRearDate() {
        return rearDate;
    }

    public void setRearDate(Date rearDate) {
