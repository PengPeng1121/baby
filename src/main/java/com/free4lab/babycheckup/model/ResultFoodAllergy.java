 ...
 */
@Entity
@Table(name = "result_food_allergy", schema = "babycheckup", catalog = "")
public class ResultFoodAllergy {
    private int id;
    private int testId;
    private int hosId;
    private int babyId;
     ...
     * 文件地址
     */
    private String foodAllergyImgUrl;
    /**
     * 备注
     */
    ...
    @Basic
    @Column(name = "food_allergy_img_url")
