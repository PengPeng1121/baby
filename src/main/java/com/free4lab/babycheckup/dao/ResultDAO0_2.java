 ...
 */
public class ResultDAO0_2 extends AbstractDAO<Result0_2> {
    private static class ResultDAOSingletonHolder {
        static ResultDAO0_2 instance = new ResultDAO0_2();
    }

    public static ResultDAO0_2 getInstance() {
        return ResultDAO0_2.ResultDAOSingletonHolder.instance;
    }

    @Override
    public Class getEntityClass() {
        return Result0_2.class;
    }
    ...
    public void saveResult(Result0_2 r) {
        super.save(r);
    }

    public List<Result0_2> findResultByBabyId(int bid){
        List<Result0_2> resultList = new ArrayList<Result0_2>();
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("babyId",bid);
        resultList = findByProperty(params,0,Integer.MAX_VALUE,"time",false);
        return resultList;
    }
    public Result0_2 findResultByid(int rid){
