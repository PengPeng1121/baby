 ...
 */
public class ResultNeiDAO extends AbstractDAO<ResultNei> {
    private static class ResultDAOSingletonHolder {
        static ResultNeiDAO instance = new ResultNeiDAO();
    }

    public static ResultNeiDAO getInstance() {
        return ResultNeiDAO.ResultDAOSingletonHolder.instance;
    }

    @Override
    public Class getEntityClass() {
        return ResultNei.class;
    }
    ...
    public void saveResult(ResultNei r) {
        super.save(r);
    }

    public List<ResultNei> findResultByBabyId(int bid){
        List<ResultNei> resultList = new ArrayList<ResultNei>();
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("babyId",bid);
        resultList = findByProperty(params,null,null,"time",false);
        return resultList;
    }
    public ResultNei findResultByid(int rid){
